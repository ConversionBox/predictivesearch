...
class LandingPageUrlRewriteGenerator
{
    ...
    /**
     * @var \Conversionbox\Predictivesearch\Model\LandingPage
     */
    ...
    /**
     * @param \Conversionbox\Predictivesearch\Model\LandingPage $landingPage
     *
    ...
    protected function createUrlRewrite($storeId, $redirectType = 0)
    {
        return $this->urlRewriteFactory->create()->setStoreId($storeId)
            ...
            ->setTargetPath('typesense/landingpage/view/landing_page_id/' . $this->landingPage->getId())
