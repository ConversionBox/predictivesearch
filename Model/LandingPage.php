...
use Conversionbox\Predictivesearch\Api\Data\LandingPageInterface;
...
{
    public const CACHE_TAG = 'conversionbox_landing_page';

    protected $_cacheTag = 'conversionbox_landing_page';

    protected $_eventPrefix = 'conversionbox_landing_page';
    ...
    {
        $this->_init(\Conversionbox\Predictivesearch\Model\ResourceModel\LandingPage::class);
    }
